...
//wrote this prototype function myself to shuffle (randomise) the questions
//without a bias
...
Quiz.prototype.guess = function(answer) {
    ...
    this.vals.push([answer,this.questions[this.questionIndex].answer]);
...
function showScores() {
    ...
    for (var i=0;i<quiz.vals.length;i++){
      gameOverHTML+= `<b>Q${i+1}/</b>The answer you gave was ${quiz.vals[i][0]}. The correct answer is ${quiz.vals[i][1]} `
